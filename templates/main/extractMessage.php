    ...
    <div class="blog-details-text">
        ...
        <p>
            ...
            <i class="text-info">multipart/form-data</i> по адресу <a class="text-success"><?php echo $url ?>
                extract/message?user_id=$id</a><br/>
            Тело запроса должно иметь 1 поле формы <i class="text-success">message</i>
        <p>
            <i>
                В поле <i class="text-success">message</i> должен находится текст который необходимо расшифровать<br/>
            </i>
            <br/>
        ...
        <?php $message = 'содержащий тело сообщения отправленого для подписи'; ?>
        </p>
